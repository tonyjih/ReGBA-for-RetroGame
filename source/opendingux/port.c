...
void ReGBA_DisplayFPS(void)
{
	...
	if (Visible)
	{
		...
		//ScaleModeUnapplied();
		PrintStringOutlineFillBG(line, RGB888_TO_RGB565(255, 255, 255), RGB888_TO_RGB565(0, 0, 0), OutputSurface->pixels, OutputSurface->pitch, 7, 3, OutputSurface->w - 14, OutputSurface->h - 12, LEFT, BOTTOM);
	}
}
